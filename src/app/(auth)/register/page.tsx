  ...
  return (
    ...
    >
      <motion.div variants={slideUpItem} className="mb-8">
        ...
        <p className="text-muted-foreground">Commencez à gérer votre budget intelligemment avec Tacynt.</p>
      </motion.div>
      ...
      <motion.form variants={slideUpItem} onSubmit={handleRegister} className="flex flex-col gap-5">
        ...
        <Button
          ...
          className="h-14 rounded-2xl w-full text-base font-semibold mt-4 shadow-lg shadow-primary/25 bg-gradient-to-r from-primary to-violet-500 hover:opacity-90 transition-opacity border-0"
        >
